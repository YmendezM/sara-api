...
class ImageServiceProviderLaravel5 extends ServiceProvider
{
    ...
    {
        return class_exists('App\\Utils\\Intervention\\Image\\ImageCache');
    }
    ...
    public function register()
    {
        ...
        $app->alias('image', 'App\Utils\Intervention\Image\ImageManager');
    }
    ...
    private function bootstrapImageCache()
    {
        ...
        if (is_string(config('imagecache.route'))) {
            ...
            $app['router']->get(config('imagecache.route').'/{template}/{filename}', [
                'uses' => 'App\Utils\Intervention\Image\ImageCacheController@getResponse',
                'as' => 'imagecache'
